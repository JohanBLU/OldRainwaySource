...
$WikiTitle = 'RainwayWiki';

##  $ScriptUrl is the URL for accessing wiki pages with a browser.
##  $PubDirUrl is the URL for the pub directory.
$ScriptUrl = 'https://rainway.xyz/Wiki/pmwiki.php';
$PubDirUrl = 'https://rainway.xyz/Wiki/pub';
...
$DefaultPasswords['admin'] = '$1$QcmN91.f$lpbYmzb9PZ85BgPaf30jV/';
